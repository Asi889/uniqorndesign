...
<div class="max-w-[1420px] px-[18px] relative mx-auto my-14  montserrat">
    ...
    <div class="letsTalkGardient relative py-[90px] lg:py-[60px] max-w-[1280px]">
        ...
        <div class="grid justify-center mt-10">
            <a class="rounded-md text-white font-semibold text-base lg:text-2xl montserrat bg-purple-500 px-4 lg:px-6 py-2 lg:py-3 hover:bg-purple-600 active:bg-purple-500" href="<?php echo $link; ?>">
                <?= pll__("Let's talk"); ?>
            </a>
        </div>
    </div>
