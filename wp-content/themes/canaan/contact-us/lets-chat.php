...
<div class="grid md:flex gap-x-[340px] justify-between  border-t-[1px] border-[#EEEEEE] mt-8 lg:mt-10 pt-8 lg:pt-10 ">
    <div class="grid gap-y-4">
        ...
        <a href="https://api.whatsapp.com/send?phone=<?php echo $whatsup; ?>" class="flex items-center px-4 lg:px-6 py-2 lg:py-3 bg-green-400 hover:bg-green-500 focus:shadow-2xl transition duration-500 pt-4 rounded-md w-fit lg:w-auto">
    ...
    <div class="">
        <h2 class="text-xl lg:text-2xl font-bold text-superDark pb-4 pt-6 lg:pt-0 montserrat hover:opacity-90 focus:opacity-75"><?= pll__(`Email us`); ?></h2>
