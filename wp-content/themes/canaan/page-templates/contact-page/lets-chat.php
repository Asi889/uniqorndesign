...
<div class="grid lg:flex gap-x-[340px] justify-between  border-t-[1px] border-[#EEEEEE] mt-8 lg:mt-10 pt-8 lg:pt-10 ">
        ...
        <h2 class="text-xl lg:text-2xl font-bold text-[#212121] py-[2px]">Let's chat</h1>
            ...
            <a class="flex items-center" href="">
                <div class="hidden lg:flex items-center pt-2 lg:pt-4">
                    ...
                    <p class="text-base lg:text-2xl text-[#212121]  pl-[10px]">+9725200000</p>
                </div>
    ...
    <div>
        <h2 class="text-xl lg:text-2xl font-bold text-[#212121] pb-4 pt-6 lg:pt-0">Email Us</h1>
            <a class="flex items-center" href="">
                <div class="hidden lg:flex items-center ">
                    <?php get_template_part('static/svgs/contact-page/letter-icon'); ?>
                    <p class="text-base lg:text-2xl text-[#212121] pl-[10px]">adam@uniqorn.design</p>
                </div>
