...
<div class="max-w-[1420px] mx-auto px-5 lg:px-0">
    ...
    <div class="py-8 lg:py-[120px]">

        <?php

        $product_hover_img = carbon_get_post_meta(get_the_ID(), 'hometop_subtitle');
        echo '<h1 class="text-[32px] lg:text-4xl leading-[39px] lg:leading-[48px] font-bold montserrat liner-blue-green-text">';
        echo $product_hover_img;
        echo '</h1>';
        ?>
        <div class="flex items-center flex-wrap px-8 py-8 lg:py-20 lg:px-0 max-w-auto lg:max-w-[1879px] mx-auto   gap-y-8 gap-x-[62px] lg:gap-x-[72px] justify-center">
