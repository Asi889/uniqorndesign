...
<div class="max-w-[1420px] mx-auto px-5 lg:px-0">
    <div class="py-[60px] lg:py20 px-5 lg:px-0">
        <h1 class="text-4xl leading-[48px] lg:text-5xl lg:leading-[58px] font-bold text-purple-600">
    ...
    <a class="rounded-md text-white font-semibold text-base lg:text-2xl montserrat bg-purple-400 px-4 lg:px-6 py-2 lg:py-3 " href="<?php echo $contact_page_link->guid; ?>">See more</a>
    </div>
