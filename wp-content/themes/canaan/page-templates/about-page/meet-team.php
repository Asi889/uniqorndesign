...
<div class="px-5 lg:px-4 montserrat mt-[60px] lg:mt-20">
    ...
    <div class="flex flex-wrap justify-center max-w-[1476px]  lg:gap-x-[140px] gap-y-8 lg:gap-y-14 mt-[60px] lg:mt-20">
        ...
        foreach ($values as $key => $v) {
            ...
            echo '<div class="container grid  max-w-[220px] max-h-[309px]">';
            ...
            echo    '<defs>';
            echo        '<pattern class="" id="img1" patternContentUnits="objectBoundingBox"  width="100%" height="100%" preserveAspectRatio="xMidYMid slice" viewBox="0 0 1 1">';
